...
# Фоновое изображение
background = pygame.image.load("D:\\.vscode\\.vscodepython\\lab8\\racer\\AnimatedStreet.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("D:\\.vscode\\.vscodepython\\lab8\\racer\\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("D:\\.vscode\\.vscodepython\\lab8\\racer\\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self, enemy):
        super().__init__()
        self.image = pygame.image.load("D:\\.vscode\\.vscodepython\\lab8\\racer\\coin.png")
        self.rect = self.image.get_rect()
...
while loop:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("D:\\.vscode\\.vscodepython\\lab8\\racer\\crash.wav").play()
        time.sleep(5)
    ...
    if pygame.sprite.spritecollide(P1, coins_group, dokill=True):
        pygame.mixer.Sound("D:\\.vscode\\.vscodepython\\lab8\\racer\\getcoin.mp3").play()
        coin_score += 1
        coin = Coin(E1)
        coins_group.add(coin)
