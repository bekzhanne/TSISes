...
sec = pg.image.load(r"D:\.vscode\.vscodepython\lab7\picture\leftarm.png").convert_alpha()
minute = pg.image.load(r"D:\.vscode\.vscodepython\lab7\picture\rightarm.png").convert_alpha()
